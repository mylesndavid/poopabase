      ...
      <div className="bg-background sticky top-0 z-25 flex w-full shrink-0 flex-col overflow-hidden border-r-0 border-b lg:w-[250px] lg:border-r lg:border-b-0">
        ...
        >
          <div className="flex flex-1 flex-col">
            ...
            <SidebarMenuItem
              selected={pathname === "/local/connect"}
              text="Connect"
              icon={Plugs}
              href="/local/connect"
            />

            {/* Cloud workspaces hidden for poopabase */}

            <SidebarMenuHeader text="Agent" />
            <SidebarMenuItem
              selected={pathname === "/local/documents"}
              text="Documents"
              icon={FileText}
              href="/local/documents"
            />
            <SidebarMenuItem
              selected={pathname === "/local/search"}
              text="Search"
              icon={MagnifyingGlass}
              href="/local/search"
            />
            <SidebarMenuItem
              selected={pathname === "/local/memory"}
              text="Memory"
              icon={Brain}
              href="/local/memory"
            />

            {/* Cloud "New Workspace" button removed for poopabase */}
          </div>
